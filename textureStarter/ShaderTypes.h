...
struct Material
{
	//trasnform the texture instead of the standard projection
	struct TexTrsfm
	{
		DirectX::SimpleMath::Vector2 scale = DirectX::SimpleMath::Vector2(1, 1);		//minify or magnify
		float angle = 0;	//2D rotation of the texture
		DirectX::SimpleMath::Vector2 translate = DirectX::SimpleMath::Vector2(0, 0);	//scroll the texture
	};
	...
	TexTrsfm texTrsfm;	//any texture transforms
